...
public class test {
    ...
    private class Node implements Comparable<test.Node> {
        //-----------------------------------------------------
        // Title: Node class
        ...
        @Override
        public int compareTo(test.Node o) {
    ...
    private void Mst() {
        ...
        test.Node[] arr = new test.Node[list.size()]; // node array to add the mst for the lexicographical order.


        for (int i = 0; i < list.size(); i++) {
            arr[i] = new test.Node(CityList[list.get(i).either()], CityList[list.get(i).other()], (int) list.get(i).weight());
    ...
    private test.Node[] bubbleSort(test.Node[] arr) {
        //--------------------------------------------------------
    ...
    public static void main(String[] args) {
        ...
        test1.Reader("C:\\Users\\m_722\\Desktop\\hmw4-part1\\src\\test4.txt");
        System.out.println();
        System.out.println();
        System.out.println();
        test test2 = new test();// test object
        test2.Reader("C:\\Users\\m_722\\Desktop\\hmw4-part1\\src\\test1.txt");

        System.out.println();
        System.out.println();
        System.out.println();
        test test3 = new test();// test object
        test3.Reader("C:\\Users\\m_722\\Desktop\\hmw4-part1\\src\\test2.txt");
        System.out.println();
        System.out.println();
        System.out.println();
        test test4 = new test();// test object
        test4.Reader("C:\\Users\\m_722\\Desktop\\hmw4-part1\\src\\test3.txt");
